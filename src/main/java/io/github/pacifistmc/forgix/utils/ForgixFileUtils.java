...
public class ForgixFileUtils {
	 ...
	 * @return `META-INF/MANIFEST.MF`, must exist, new
	 */
	public static File createManifestFile(File dir) throws IOException {
		File meta = getManifestFile(dir);
		if (meta.exists()) {
			meta.delete();
	...
	/**
	 * @param dir That should contain the META-INF directory
	 * @return `META-INF/MANIFEST.MF` just reference
	 */
	public static File getManifestFile(File dir) {
